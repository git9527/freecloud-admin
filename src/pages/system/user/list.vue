<template>
  <view>
    ...
    <view class="uni-container">
      <uni-clientdb ref="udb" :collection="collectionName" :options="options" :where="where" field="username,role{role_id,role_name},mobile,site,status,register_date"
        ...
        <uni-table :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection"
         @selection-change="selectionChange">
          ...
          <uni-tr v-for="(item,index) in data" :key="index">
            ...
            <uni-td align="center">{{item.site}}</uni-td>
